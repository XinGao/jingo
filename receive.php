...
<html>
	...
	<body>
		...
		<input type="submit" name="receive" value="receive" style="margin-left:50px;font-size:30px"/>
		</select>
		</p>
		</form>

		
<!--		<strong>location:</strong> <select name="curlocation" onchange="showloc()">
			<option>current location</option>
			<option>select location</option></select>
		<input type="text" name="loc_select" id="loc_select" style="display:none" onclick="javascript:openMyWindow();" size="27"/>
