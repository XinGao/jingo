...
<html>
	...
	<body>
		<div id="header">
<!--			<a><p id="name"><?php echo $_SESSION['uname']?></p></a>
			<a href="login.php?action=logout"><p id="logout">logout</p></a>
-->
        <?php
...
//					
				while($result_1 = mysql_fetch_array($tag_query)){
					echo"<input type='checkbox' style='font-size:23px' name='tag[]' value='".$result_1['tag']."'/>".$result_1['tag'];
				}
			...
			<input type="submit" value = "create" style="margin-left:50px;font-size:30px"/>
			</p>
		</form>
